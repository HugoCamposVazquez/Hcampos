...
import * as sty from "./PlasmicHeroSection2.module.css"; // plasmic-import: N7m7eE-uE1FT/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <Navigation
              className={classNames("__wab_instance", sty.navigation__uAf02)}
              hideCta={"hideCta" as const}
            >
              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img___2LZrF)}
                role={"img"}
            ...
            defaultContents: (
              <React.Fragment>
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.freeBox___0Qote)}
                >
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.freeBox__lutGe)}
                  >
                    <div
                      className={classNames(defaultcss.all, sty.freeBox__sG0Xd)}
                    >
                      <div
                  ...
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.freeBox__n5Dh0)}
                  >
                    <Button
                      className={classNames(
                        "__wab_instance",
                    ...
                    <Button
                      ...
                      className={classNames("__wab_instance", sty.button__fpOu)}
                      darkGray={"darkGray" as const}
                      slot={
                        <div
                          className={classNames(
                ...
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.freeBox__mxoNm)}
                >
                  <div
                    className={classNames(defaultcss.all, sty.freeBox__bfBvw)}
                  >
                    <p.Stack
                      as={"div"}
                      hasGap={true}

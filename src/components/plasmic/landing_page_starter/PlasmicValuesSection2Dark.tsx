...
import * as sty from "./PlasmicValuesSection2Dark.module.css"; // plasmic-import: -ldHHZatxycY/css
          ...
          defaultContents: (
            <React.Fragment>
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.freeBox__tceFk)}
              >
                <div
                ...
                <Button
                  children2={
                    <Icon17Icon
                      className={classNames(defaultcss.all, sty.svg__pdlKp)}
                      role={"img"}
                    />
                  }
                  className={classNames("__wab_instance", sty.button__hLewp)}
              ...
              <div className={classNames(defaultcss.all, sty.freeBox__t6D2B)}>
                <ListItem
                  bottomBorder={"dark" as const}
                  className={classNames("__wab_instance", sty.listItem___468N)}
                  slot={
                    <Icon16Icon
                      className={classNames(defaultcss.all, sty.svg__kOy6N)}
                      role={"img"}
                    />
                  }
                >
                ...
                <ListItem
                  bottomBorder={"dark" as const}
                  className={classNames("__wab_instance", sty.listItem___12CwW)}
                  slot={
                    <Icon16Icon
                      className={classNames(defaultcss.all, sty.svg__gdWeq)}
                      role={"img"}
                    />
                  }
                >
                ...
                <ListItem
                  bottomBorder={"dark" as const}
                  className={classNames("__wab_instance", sty.listItem__uvty6)}
                  slot={
                    <Icon16Icon
                      className={classNames(defaultcss.all, sty.svg___6H4F)}
                      role={"img"}
                    />
                  }
                >
                ...
                <ListItem
                  bottomBorder={"dark" as const}
                  className={classNames("__wab_instance", sty.listItem__h4Bw7)}
                  slot={
                    <Icon16Icon
                      className={classNames(defaultcss.all, sty.svg__xN2Za)}
                      role={"img"}
                    />
                  }
                >
                ...
                <ListItem
                  className={classNames("__wab_instance", sty.listItem__ra2Ar)}
                  slot={
                    <Icon16Icon
                      className={classNames(defaultcss.all, sty.svg__nbqa)}
                      role={"img"}
                    />
                  }
                >

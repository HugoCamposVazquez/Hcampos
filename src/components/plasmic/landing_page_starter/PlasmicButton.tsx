...
import * as sty from "./PlasmicButton.module.css"; // plasmic-import: tW89Zefd9lZn/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(defaultcss.all, sty.svg__pkBqO)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(defaultcss.all, sty.svg___8KTdD)}
                role={"img"}
              />
            ),

...
import * as sty from "./PlasmicShopBanners.module.css"; // plasmic-import: -58tpuVqM8kJ/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <React.Fragment>
            <Banner
              className={classNames("__wab_instance", sty.banner___5OrE)}
            />

            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox__qEDm)}
            >
              <Banner
                className={classNames("__wab_instance", sty.banner__idZSz)}
              >
                <img
                  alt={""}
                  className={classNames(defaultcss.img, sty.img__nMvtA)}
                  role={"img"}
                  src={
              ...
              <Banner
                className={classNames("__wab_instance", sty.banner___88Bx)}
              >
                <img
                  alt={""}
                  className={classNames(defaultcss.img, sty.img__bpTwO)}
                  role={"img"}
                  src={

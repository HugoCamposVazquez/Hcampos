...
import * as sty from "./PlasmicValueprop.module.css"; // plasmic-import: iqLVo_SBs1q1/css
...
function PlasmicValueprop__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.freeBox__mgoQ2, {
          [sty.freeBox__card__mgoQ2G67Lw]: hasVariant(variants, "card", "card"),
          [sty.freeBox__card_vertical__mgoQ2G67Lw9A3Yx]:
            hasVariant(variants, "card", "card") &&
            hasVariant(variants, "vertical", "vertical"),
          [sty.freeBox__color_lightQuarternary__mgoQ2W0MMx]: hasVariant(
            variants,
            "color",
            "lightQuarternary"
          ),
          [sty.freeBox__flatIcon__mgoQ2Zk41U]: hasVariant(
            variants,
            "flatIcon",
            "flatIcon"
          ),
          [sty.freeBox__flat__mgoQ2L5Nfx]: hasVariant(variants, "flat", "flat"),
          [sty.freeBox__vertical__mgoQ29A3Yx]: hasVariant(
            variants,
            "vertical",
            "vertical"
          )
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <img
              alt={""}
              className={classNames(defaultcss.img, sty.img__dOBq8)}
              role={"img"}
              src={
      ...
      {false ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__g2DPx, {
            [sty.freeBox__card__g2DPxG67Lw]: hasVariant(
              variants,
              "card",
              "card"
            ),
            [sty.freeBox__card_vertical__g2DPxG67Lw9A3Yx]:
              hasVariant(variants, "card", "card") &&
              hasVariant(variants, "vertical", "vertical"),
            [sty.freeBox__color_lightQuarternary__g2DPxw0MMx]: hasVariant(
              variants,
              "color",
              "lightQuarternary"
            ),
            [sty.freeBox__flatIcon__g2DPxzk41U]: hasVariant(
              variants,
              "flatIcon",
              "flatIcon"
            ),
            [sty.freeBox__flat__g2DPxL5Nfx]: hasVariant(
              variants,
              "flat",
              "flat"
            ),
            [sty.freeBox__vertical__g2DPx9A3Yx]: hasVariant(
              variants,
              "vertical",
              "vertical"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon8Icon
                className={classNames(defaultcss.all, sty.svg___3OuUl)}
                role={"img"}
              />
            ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__wgKoi, {
          [sty.freeBox__flat__wgKoil5Nfx]: hasVariant(variants, "flat", "flat"),
          [sty.freeBox__justDescription__wgKoIjoSu3]: hasVariant(
            variants,
            "justDescription",
            "justDescription"
          )

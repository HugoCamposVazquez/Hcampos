...
import Logo from "../../Logo"; // plasmic-import: SScVF8CzNYgt/component
...
import * as sty from "./PlasmicNavigation.module.css"; // plasmic-import: ZnkrLNpX776i/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__tGheO, {
          [sty.freeBox__centered__tGheOpUdtv]: hasVariant(
            variants,
            "centered",
            "centered"
          ),
          [sty.freeBox__dark__tGheOm15Eu]: hasVariant(variants, "dark", "dark")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <Logo className={classNames("__wab_instance", sty.logo__cxAB)} />
          ),
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__rgky, {
            [sty.freeBox__centered__rgkyPUdtv]: hasVariant(
              variants,
              "centered",
              "centered"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <Button
                  className={classNames("__wab_instance", sty.button__wOjWy)}
                  navLink={"navLink" as const}
                  slot={"Services"}
                />

                <Button
                  className={classNames("__wab_instance", sty.button__prrQe)}
                  navLink={"navLink" as const}
                  slot={"Features"}
                />

                <Button
                  className={classNames("__wab_instance", sty.button__dr9Nc)}
                  navLink={"navLink" as const}
                  slot={"Company"}
                />

                <Button
                  className={classNames("__wab_instance", sty.button__ngT7O)}
                  navLink={"navLink" as const}
                  slot={"Contact"}
                />

                <Button
                  className={classNames("__wab_instance", sty.button__tB9Fl)}
                  navLink={"navLink" as const}
                  slot={"Log in"}
                />

                <Button
                  className={classNames("__wab_instance", sty.button__aQoPu)}
        ...
        {(hasVariant(variants, "centered", "centered") ? true : false) ? (
          <div
            className={classNames(defaultcss.all, sty.freeBox__earuz, {
              [sty.freeBox__centered__earuZpUdtv]: hasVariant(
                variants,
                "centered",
                "centered"
              )
          ...
          >
            {(hasVariant(variants, "centered", "centered") ? false : true) ? (
              <button
                className={classNames(
                  ...
                  sty.button__qLaBc,
                  {
                    [sty.button__centered__qLaBcpUdtv]: hasVariant(
                      variants,
                      "centered",
                      "centered"
                    ),
                    [sty.button__dark__qLaBcM15Eu]: hasVariant(
                      variants,
                      "dark",
                      "dark"
                    )
            ...
            <Button
              className={classNames("__wab_instance", sty.button___90Wk, {
                [sty.button__dark___90Wkm15Eu]: hasVariant(
                  variants,
                  "dark",
                  "dark"
                )

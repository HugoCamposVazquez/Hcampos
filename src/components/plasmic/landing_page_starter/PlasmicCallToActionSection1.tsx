...
import * as sty from "./PlasmicCallToActionSection1.module.css"; // plasmic-import: PzVBxOVt1zUE/css
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <img
                  alt={""}
                  className={classNames(defaultcss.img, sty.img__n1Dwi)}
                  role={"img"}
                  src={
                ...
                <div
                  className={classNames(defaultcss.all, sty.freeBox___3GId)}
                />
              </React.Fragment>
            ),
            value: args.art
            ...
            defaultContents: (
              <React.Fragment>
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.freeBox__ndZci)}
                >
                  <div
                ...
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.freeBox___4C634)}
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__kcGtg)}
                  ...
                  <Button
                    ...
                    className={classNames("__wab_instance", sty.button__bvIsz)}

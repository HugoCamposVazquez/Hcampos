...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: 0IQ_Zu-6dz81/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__nHVrK)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__q8Gcy)}
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <img
              alt={""}
              className={classNames(defaultcss.img, sty.img__mHxqM)}
              role={"img"}
            />
          ),
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__rGiRm)}
        >
          <div className={classNames(defaultcss.all, sty.freeBox__jQFmB)}>
            {p.renderPlasmicSlot({
